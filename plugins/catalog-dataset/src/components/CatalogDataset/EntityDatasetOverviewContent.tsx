...
export const EntityDatasetOverviewContent = () => {
  ...
  const { value: ownerEntity } = useAsync(async () => {
    if (!spec.owner) {
      return undefined;
    }
  ...
  const ownerLabel =
    (ownerEntity?.spec?.profile as { displayName?: string } | undefined)
      ?.displayName ??
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent>
              ...
              <Typography variant="body2">
                <Link href="#about-this-dataset">About this Dataset</Link>
              </Typography>
              ...
              <Typography variant="body2">
                <Link href="#access-methods">Access Methods</Link>
              </Typography>
              <Typography variant="body2">
              ...
              <Typography variant="body2">
                <Link href="#lineage-and-quality">Lineage and Quality</Link>
              </Typography>
              <Typography variant="body2">
        ...
        <Grid item xs={12} md={8}>
          ...
          <div id="related-resources">
            <RelatedResourcesCard relatedResources={spec.relatedResources} />
          </div>
        </Grid>
      </Grid>
