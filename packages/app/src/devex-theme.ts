...
const createCustomThemeOverrides = (
  ...
  return {
    ...
    MuiSvgIcon: {
      root: {
        fill: tokens.typographyColorPrimaryInvert,
      },
    },
    MuiInput: {
      underline: {
        ...
        '&.Mui-disabled.MuiInputBase-multiline:before': {
          borderBottom: 'none',
        },
        '&.Mui-disabled:after': {
          borderBottom: 'none',
        },
        '&.Mui-disabled.MuiInputBase-multiline:after': {
          borderBottom: 'none',
        },
      },
    },
    MuiInputBase: {
      input: {
        ...
        '&[disabled][class*="MuiInputBase-inputMultiline"]': {
